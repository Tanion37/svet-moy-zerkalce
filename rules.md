...
- Игрок выкладывает **от 1 до 3** карт букв. Это первые буквы слова или выражения либо самые характерные для него буквы. Слово или выражение игрок **называет вслух**.
- Лишние карты букв остаются в центре стола.
- Ответ может быть одним словом или фразой – **на усмотрение игрока**.
