...
Режим «Для опытных» описан отдельно: раздача по 10 карт букв в руку, ответ только из руки, рассказ перед голосованием и передача использованных карт букв соседу слева. См. [rules-experienced.md](rules-experienced.md).
