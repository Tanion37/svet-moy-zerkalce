...
def build_book(book: Book) -> None:
    ...
    book.body(
        [
            ...
            "Выложите от 1 до 3 карт букв: первые или самые характерные буквы слова или выражения. Слово или выражение назовите вслух. Лишние карты букв остаются в центре стола.",
    ...
    book.side_by_side(
        [
            "Ответ – от 1 до 3 карт букв: первые или самые характерные буквы слова или выражения. Слово или выражение назовите вслух. Допустимы несуществующие и неполные слова.",
    ...
    book.body(
        [
            "Пример: запрос «Чем соблазнить милф». Настя выложила Б и Т и назвала «без трусов» (позже получит 3 голоса), Артём выложил П и Д и назвал «в подъезде» (1 голос), Кирилл выложил М, А и Д и назвал «мамин друг» (0 голосов).",
        ],
        size=11,
        italic=True,
    )
    ...
    book.body(
        [
            ...
            "? Сколько карт букв выкладывать в ответ?  От 1 до 3: первые или самые характерные буквы слова или выражения. Слово или выражение назовите вслух.",
    ...
    book.body(
        [
            ...
            "2. Взять от 1 до 3 карт букв (одна рука, по одной карте), выложить их и назвать слово или выражение.",
